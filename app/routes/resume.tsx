...
const SkillsSection: FC = function () {
  return (
...
const FullTimeSection: FC = function () {
  return (
    <section className="pb-8">
      <header>
      ...
      <article>
        ...
        <ul>
          ...
          <li>
            Collaborate with university heads to design pages viewed by millions
            every year.
          </li>
        </ul>
      </article>
...
const ContractSection: FC = function () {
  return (
    <section className="pb-8">
      <header>
      ...
      <article className="pb-6">
        <header>
          <h4>Flowbite Pro: React Admin Dashboard</h4>
          <p>
            After my open-source contributions to&nbsp; flowbite-react, the team
            at Themesberg asked me to create a React version of their beautiful
            Admin Dashboard. We just launched, and I'm very excited to see
            people use it.
          </p>
          <p>
            If you like Flowbite as much as I do, consider getting Flowbite Pro.
            It's pretty sweet, and it includes this React Admin Dashboard. You
            can&nbsp;
          ...
          <p>
            There's also a completely free version of Flowbite's Admin Dashboard
            in React, which you can&nbsp;
          ...
          <div className="flex gap-6">
            <a href="https://flowbite.com/react-admin-dashboard-pro/preview/">
              &rarr; View Flowbite Pro: React Admin Dashboard
            </a>
          </div>
        </header>
      </article>
      <article className="pb-6">
        ...
        <p>
          ...
          <a href="https://tailwindcss.com">tailwindcss</a>. Changes can be made
          effortlessly, and go live in less than two minutes using&nbsp;
          <a href="https://pages.cloudflare.com/">Cloudflare Pages.</a>
        </p>
        <p>
          I also helped the client transition to a CRM, which immensely reduced
          the time they spend sending emails and organizing a handwritten
          datebook.
        </p>
      ...
      <article>
        ...
        <p>
          I used Wordpress 5's blocks system to create a template the client can
          easily update on their own.
        </p>
...
const PersonalWorkSection: FC = function () {
  return (
    <section className="pb-8">
      <header>
        <h3>Personal work</h3>
        ...
        <header>
          ...
          <p>
            ...
            <a href="https://github.com/themesberg/flowbite-react/pulls?q=is%3Apr+author%3Atulup-conner">
              ...
              flowbite-react on Github.
            </a>
          </p>
          <p>Now I'm the project's maintainer.</p>
          <p>
            <a href="https://flowbite.com">Flowbite</a> is an open source design
            system built on&nbsp;
            <a href="https://tailwindcss.com">Tailwind CSS</a>. flowbite-react
            brings that to your React site.
          </p>
          <p>
      ...
      <article className="pb-6">
        <header>
          ...
          <p>
            ...
            flowbite-react, and deployed to Remix on Cloudflare Pages.
          </p>
          <div className="flex gap-6">
            <a href="https://waterbear.design">&rarr; View waterbear.design</a>
          </div>
        </header>
      </article>
      <article className="pb-6">
        ...
        <p>
          A "bookmarklet" anyone can add to their browser for extra features on{" "}
          <a href="https://plug.dj">Plug.dj</a>.
        </p>
        <p>
          During its use, it was downloaded by tens of thousands of unique users
          across the globe.
        </p>
        <p>
      ...
      <article className="pb-6">
        ...
        <p>
          ...
          Users can browse the database or submit their own business, which must
          be approved.
        </p>
        <p>
      ...
      <article className="pb-6">
        ...
        <p>
          Web app suggests class schedules to students at Santa Clara University
          by using their degree progress. Students select classes they have
          taken, the app generates efficient schedules with classes they still
          need.
        </p>
        <p>
      ...
      <article className="pb-6">
        ...
        <p>
          The compiler includes semantic and syntactic checking with compilation
          error reports. The code generator produces executable Assembly code
          for 64-bit Intel machines running Linux. This was my favorite thing in
          school.
        </p>
      ...
      <article>
        ...
        <p>
          Really simple web app built with React and TypeScript. Uses Web Audio
          API, a fairly new web standard, to visualize audio waveforms. Supports
          direct input through a microphone as well as recorded tracks.
        </p>
...
const EducationSection: FC = function () {
  return (
    <section>
      <header>
        <h3>Education</h3>
